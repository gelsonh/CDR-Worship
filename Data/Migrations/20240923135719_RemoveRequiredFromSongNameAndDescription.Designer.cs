...
namespace CDR_Worship.Migrations
{
    ...
    [Migration("20240923135719_RemoveRequiredFromSongNameAndDescription")]
    partial class RemoveRequiredFromSongNameAndDescription
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("CDR_Worship.Models.Calendar", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("CDR_Worship.Models.ScheduledSong", b =>
                {
                    ...
                    b.HasOne("CDR_Worship.Models.CalendarDay", null)
                        .WithMany("Songs")
